...
class Questions:
    def __init__(self, master):
        ...
        self.label = Label(master, text="Hi!  You can add questions to the\
text file here.")
        self.label.pack()
        ...
        # Create an add button that adds the question to a text file when
        # pressed
    ...
    def add(self):
        ...
        if (len(self.entry.get().strip()) != 0):
            with open('questions.txt', 'a') as f:
                ...
                # TODO (feature): notify the user that the question has been
                #                 added to the text file and clear what the
                #                 user just wrote
